...
import com.xavier.mozdeliveryapi.tenant.domain.event.TenantComplianceUpdatedEvent;
import com.xavier.mozdeliveryapi.tenant.domain.event.TenantConfigurationUpdatedEvent;
import com.xavier.mozdeliveryapi.tenant.domain.event.TenantCreatedEvent;
import com.xavier.mozdeliveryapi.tenant.domain.event.TenantStatusChangedEvent;
import com.xavier.mozdeliveryapi.tenant.domain.event.TenantSuspendedEvent;
