...
import com.xavier.mozdeliveryapi.payment.domain.PaymentService;
import com.xavier.mozdeliveryapi.payment.domain.Refund;
import com.xavier.mozdeliveryapi.payment.domain.RefundId;
import com.xavier.mozdeliveryapi.payment.domain.RefundService;
...
public class PaymentApplicationServiceImpl implements PaymentApplicationService {
    ...
    @Override
    public List<PaymentResponse> getPaymentsForOrder(com.xavier.mozdeliveryapi.order.domain.OrderId orderId) {
    ...
    public PaymentStatusResponse checkPaymentStatus(PaymentId paymentId) {
        ...
        com.xavier.mozdeliveryapi.payment.domain.PaymentStatusResponse status =
    ...
    public RefundStatusResponse checkRefundStatus(RefundId refundId) {
        ...
        com.xavier.mozdeliveryapi.payment.domain.RefundStatusResponse status =
