...
import com.xavier.mozdeliveryapi.payment.application.usecase.port.MPesaGateway;
...
public class MPesaGatewayImpl implements MPesaGateway {
    ...
    public PaymentStatusResponse checkPaymentStatus(String gatewayTransactionId) {
        try {
            ...
            com.xavier.mozdeliveryapi.shared.domain.valueobject.PaymentStatus paymentStatus;
            if ("0".equals(status.resultCode())) {
                paymentStatus = com.xavier.mozdeliveryapi.shared.domain.valueobject.PaymentStatus.COMPLETED;
            } else if ("1032".equals(status.resultCode())) {
                paymentStatus = com.xavier.mozdeliveryapi.shared.domain.valueobject.PaymentStatus.CANCELLED;
            } else {
                paymentStatus = com.xavier.mozdeliveryapi.shared.domain.valueobject.PaymentStatus.FAILED;
            }
            ...
            return PaymentStatusResponse.of(
                com.xavier.mozdeliveryapi.shared.domain.valueobject.PaymentStatus.FAILED,
